        ...
        <DialogContent className="bg-white">
          ...
          <div className="space-y-4">
            <div className="grid gap-2">
              ...
              {/* No validation limits for vendor price */}
            </div>
            <div className="grid gap-2">
              ...
              />
              {/* No validation limits for vendor duration */}
            </div>
            <div className="grid gap-2">
          ...
          <DialogFooter>
            <Button
              disabled={saving || !selectedProject || submittedProjects.has(String(selectedProject?.id || ''))}
              onClick={() => {
                ...
                (async () => {
                  try {
                    ...
                    const res = await createBid(pid, { price: Number(offerPrice || 0), days: Number(offerDays || 0), message: offerMessage });
                    if (res.ok) {
