                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        try {
                          ...
                          url.searchParams.set('serviceId', sid);
                          url.searchParams.set('page', 'technician-service-details');
                          window.history.replaceState({}, '', url.toString());
                        } catch {}
                        try { window.localStorage.setItem('selected_service_id', sid); } catch {}
          ...
          <DialogFooter>
            <Button
              ...
              onClick={() => {
                ...
                if (!isFinite(priceNum) || !Number.isFinite(daysNum)) {
                  toastError(isAr ? 'أدخل أرقاماً صحيحة للسعر والمدة' : 'Please enter valid numbers for price and days', isAr);
                  return;
                }
                (async () => {
                  try {
