...
export const routes: Record<string, RouteConfig> = {
  ...
  'vendor-dashboard': { component: VendorDashboard, title: 'لوحة التحكم', icon: BarChart3, requiresAuth: true, allowedRoles: ['vendor','merchant'] },
  'vendor-products': { component: VendorProducts, title: 'منتجاتي', icon: Package, requiresAuth: true, allowedRoles: ['vendor','merchant'] },
  'vendor-orders': { component: VendorOrders, title: 'الطلبات', icon: FileText, requiresAuth: true, allowedRoles: ['vendor','merchant'] },
  'vendor-analytics': { component: VendorAnalytics, title: 'التحليلات', icon: TrendingUp, requiresAuth: true, allowedRoles: ['vendor','merchant'] },
  'vendor-accounting': { component: VendorAccounting, title: 'النظام المحاسبي', icon: TrendingUp, requiresAuth: true, allowedRoles: ['vendor','merchant'] },
  'vendor-projects': { component: VendorProjects, title: 'مشاريعي', icon: Tag, requiresAuth: true, allowedRoles: ['vendor','merchant'] },
  'vendor-project-details': { component: VendorProjectDetails, title: 'تفاصيل مشروع', icon: Tag, requiresAuth: true, allowedRoles: ['vendor','merchant'] },
  'vendor-services': { component: VendorServices, title: 'خدماتي', icon: Tag, requiresAuth: true, allowedRoles: ['vendor','merchant'] },
  'vendor-rentals': { component: VendorRentals, title: 'التأجير', icon: Tag, requiresAuth: true, allowedRoles: ['vendor','merchant'] },
  'vendor-service-applicants': { component: VendorServiceApplicants, title: 'المتقدمون على الخدمات', icon: Users, requiresAuth: true, allowedRoles: ['vendor','merchant'] },
  'vendor-chat': { component: VendorChat, title: 'مراسلة الفني', icon: Users, requiresAuth: true, allowedRoles: ['vendor','merchant'] },
