...
export const faqs = [
  // General Questions
  {
    id: 1,
    category: 'general',
    question: 'ما هي منصة Neoteric؟',
    answer: 'منصة Neoteric هي متجر إلكتروني متخصص في خدمات ومنتجات المقاولات الأصلية والعالية الجودة. نحن نربط بين العملاء والبائعين المتخصصين لتوفير أفضل المنتجات بأسعار تنافسية.',
    popular: true
  },
  {
    id: 2,
    category: 'general',
    question: 'كيف يمكنني العثور على المنتج أو الخدمة المناسبة؟',
    answer: 'يمكنك البحث باستخدام اسم المنتج، الفئة، أو تصفح الأقسام المختلفة. كما يمكنك استخدام فلاتر البحث لإظهار المنتجات والخدمات المناسبة لمشروعك.',
    popular: true
  },
  {
    id: 3,
