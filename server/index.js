...
import rentalCategoriesRoutes from './routes/rentalCategories.routes.js';
...
app.use('/api/products', productsRoutes); // Add lowercase alias
...
app.use('/api/RentalCategories', rentalCategoriesRoutes);
